    ...
    return (
        <div className='bg-emerald-800'>
            ...
            <div className="text-center py-16">
                <h1 className='font-bold text-gray-200 text-xl'>Our partnership service team is waiting for you to join us !</h1>
                <p className='max-w-2xl mx-auto my-4 text-gray-300'>Our partnership service team is dedicated to helping massage shops like yours thrive in today's market. 
